      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative h-96 rounded-2xl overflow-hidden shadow-xl">
             <img src="https://images.unsplash.com/photo-1549488344-c1fac1bf54ef?q=80&w=2070&auto=format&fit=crop" alt="Buytech Headquarters" className="w-full h-full object-cover" referrerPolicy="no-referrer" />
          </div>
        </div>
      </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="p-6 bg-blue-800 rounded-xl">
              <div className="bg-blue-700 w-12 h-12 flex items-center justify-center rounded-lg mb-4 text-xl font-bold text-blue-200">1</div>
              <p className="text-lg font-medium">Deliver innovative products at competitive prices.</p>
            </div>
            <div className="p-6 bg-blue-800 rounded-xl">
              <div className="bg-blue-700 w-12 h-12 flex items-center justify-center rounded-lg mb-4 text-xl font-bold text-blue-200">2</div>
              <p className="text-lg font-medium">Promote energy-efficient technology.</p>
            </div>
            <div className="p-6 bg-blue-800 rounded-xl">
              <div className="bg-blue-700 w-12 h-12 flex items-center justify-center rounded-lg mb-4 text-xl font-bold text-blue-200">3</div>
              <p className="text-lg font-medium">Provide exceptional customer service.</p>
            </div>
            <div className="p-6 bg-blue-800 rounded-xl">
              <div className="bg-blue-700 w-12 h-12 flex items-center justify-center rounded-lg mb-4 text-xl font-bold text-blue-200">4</div>
