...
export default function Services() {
  return (
    <div className="bg-white pb-16 min-h-screen">
      ...
      {/* Services List */}
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16" aria-label="Our Services">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div className="bg-white p-8 rounded-xl shadow-sm border border-gray-100 text-center">
            <Wrench className="h-12 w-12 mx-auto text-blue-600 mb-6" aria-hidden="true" />
          ...
          <div className="bg-white p-8 rounded-xl shadow-sm border border-gray-100 text-center">
            <Shield className="h-12 w-12 mx-auto text-indigo-600 mb-6" aria-hidden="true" />
          ...
          <div className="bg-white p-8 rounded-xl shadow-sm border border-gray-100 text-center">
            <Clock className="h-12 w-12 mx-auto text-green-500 mb-6" aria-hidden="true" />
          ...
          <div className="bg-white p-8 rounded-xl shadow-sm border border-gray-100 text-center">
            <ThumbsUp className="h-12 w-12 mx-auto text-red-500 mb-6" aria-hidden="true" />
