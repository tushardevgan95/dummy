      ...
      <header className="bg-white py-12 border-b border-gray-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h1 className="text-4xl font-extrabold text-gray-900 tracking-tight">
            Explore Our Premium Smart Home Appliances
          </h1>

          <p className="mt-4 text-xl text-gray-500 max-w-2xl mx-auto">
            Explore our premium range of smart home appliances designed to
      ...
      >
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          {products.map((product) => (
            <article
              key={product.id}
              className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden flex flex-col md:flex-row transition-shadow hover:shadow-md"
            >
                  ...
                  <ul className="space-y-2">
                    {product.features.map((feature, idx) => (
                      <li key={idx} className="flex items-start">
                        ...
                        <span className="text-gray-700 text-sm leading-tight pt-0.5">
                          {feature}
                        </span>
                      </li>
                    ))}
        ...
        <div className="bg-blue-50 border border-blue-100 rounded-2xl p-8 md:p-12 text-center md:text-left flex flex-col md:flex-row items-center justify-between shadow-sm">
          <div className="mb-6 md:mb-0 md:mr-8 flex-grow">
            ...
            <p className="text-blue-800 mb-4 text-lg">
              All buytech products come with our signature commitment to quality:
            </p>
